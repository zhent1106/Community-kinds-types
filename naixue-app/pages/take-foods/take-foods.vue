          ...
          <view class="section">
            ...
            <list-cell :hover="false">
              <view class="w-100 d-flex align-items-center">
                ...
                <view
                  class="d-flex justify-content-end align-items-center w-40"
                >
                  <image
            ...
            <list-cell :hover="false" padding="50rpx 30rpx">
              <view class="w-100 d-flex flex-column">
                <view class="pay-cell">
                  <view>下单时间</view>
                  <view class="font-weight-bold"
                    >{{ orderCurrent.createOrderTime }}</view
                  >
                </view>
                <view class="pay-cell">
                  <view>下单门店</view>
                  <view class="font-weight-bold"
                    >{{ orderCurrent.chooseStore }}</view
                  >
                </view>
                <view class="pay-cell">
                  <view>支付方式</view>
